      ...
      <div className={`${styles.bg} ${styles.border} border rounded-lg shadow-lg p-4 max-w-sm`}>
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0">
            <button
              onClick={handleClose}
              className={`inline-flex ${styles.text} hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-green-600`}
            >
